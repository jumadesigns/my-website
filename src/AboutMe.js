  ...
  return (
    ...
    <div className="exp-sec">
        ...
        <div className="div-2">
          <div>
            <p style={{ marginBottom: "35px" }}>
              ...
              <br></br>
              <span id="subtitle">Front-end Enginner + UI/UX Designer<br></br></span>
            </p>

            <p style={{ marginBottom: "35px" }}>
              <b>ShopFabulus</b>
              <br></br>
              <span id="subtitle">Front-end Enginner + Product Designer<br></br></span>
            </p>

            <p style={{ marginBottom: "35px" }}>
              <b>Staples Connect</b>
              <br></br>
              <span id="subtitle">Front-end Enginner + Development Specialist<br></br></span>
            </p>

            <p style={{ marginBottom: "35px" }}>
              <b>Accountivity Outsourcing</b>
              <br></br>
              <span id="subtitle">Fullstack Enginner + UI/UX Designer<br></br></span>
            </p>
          ...
          <div>
            <p style={{ marginBottom: "35px" }}>
              ...
              <br></br>
              <span id="subtitle">Full time<br></br></span>
            </p>
            ...
            <p style={{ marginBottom: "35px" }}>
              ...
              <br></br>
              <span id="subtitle">Short term contract<br></br></span>
            </p>

            <p style={{ marginBottom: "35px" }}>
              <b>June 2020 - December 2020</b>
              <br></br>
              <span id="subtitle">Short term contractr<br></br></span>
            </p>

            <p style={{ marginBottom: "35px" }}>
              <b>March 2016 - March 2017</b>
              <br></br>
              <span id="subtitle">Contract<br></br></span>
            </p>
          </div>
        </div>
      </div>
     ...
     <div className="div-3">
        ...
        <p>
        I am an <b>Audio engineer</b>, <b>classical guitarist</b>, <b>music producer</b> & a <b>performer</b>   
        </p>
